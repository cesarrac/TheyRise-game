...
public class Building_UIHandler : MonoBehaviour {
	...
	cannonSprite, sFarmSprite, storSprite, sDesaltSprite, sniperSprite, nutriSprite, genSprite;
...
//	string currBuildingName;
	...
	public int[] extractCost, mGunCost, seaWCost, hHallCost, cannonCost,sFarmCost, storageCost, sDesaltCost,
		sniperCost, nutriCost, generatorCost;
...
//	public Player_SpawnHandler playerSpawn;
	...
	void InitBuildCosts(){
		...
		generatorCost = resourceGrid.generatorCost;
	}
	...
	void CreateBuildingButtons(){
		...
		BuildButton (buildBttnFab,extractSprite, mainBuildPanel, corners, corners, 
		             new Vector3 (52f, 10f, 0), new Vector2 (32, 32), buildingNames[0], extractCost[0], extractCost[1]); 

		BuildButton (buildBttnFab,sDesaltSprite, mainBuildPanel, corners, corners, 
		             new Vector3 (52f, 90f, 0), new Vector2 (32, 32),buildingNames[5], sDesaltCost[0], sDesaltCost[1]);

		BuildButton (buildBttnFab,machineGunSprite, mainBuildPanel, corners, corners, 
		             new Vector3 (146f, 10f, 0), new Vector2 (32, 32), buildingNames[1], mGunCost[0], mGunCost[1]); 

		BuildButton (buildBttnFab,cannonSprite, mainBuildPanel, corners, corners, 
		             new Vector3 (146f, 90f, 0), new Vector2 (32, 32), buildingNames[2], cannonCost[0], cannonCost[1]); 

		BuildButton (buildBttnFab,seaWSprite, mainBuildPanel, corners, corners, 
		             new Vector3 (240f, 10f, 0), new Vector2 (32, 32), buildingNames[3], seaWCost[0], seaWCost[1]);

		BuildButton (buildBttnFab,sniperSprite, mainBuildPanel, corners, corners, 
		             new Vector3 (240f, 90f, 0), new Vector2 (32, 32), buildingNames[7], sniperCost[0], sniperCost[1]);

		BuildButton (buildBttnFab,sFarmSprite, mainBuildPanel, corners, corners, 
		             new Vector3 (334f, 10f, 0), new Vector2 (32, 32),buildingNames[4], sFarmCost[0], sFarmCost[1]);

		BuildButton (buildBttnFab,nutriSprite, mainBuildPanel, corners, corners, 
		             new Vector3 (334f, 90f, 0), new Vector2 (32, 32),buildingNames[8], nutriCost[0], nutriCost[1]);

		BuildButton (buildBttnFab,storSprite, mainBuildPanel, corners, corners, 
		             new Vector3 (428f, 10f, 0), new Vector2 (32, 32),buildingNames[6], storageCost[0], storageCost[1]);

		BuildButton (buildBttnFab,genSprite, mainBuildPanel, corners, corners, 
		             new Vector3 (428f, 90f, 0), new Vector2 (32, 32),buildingNames[9], generatorCost[0], generatorCost[1]);
	}
